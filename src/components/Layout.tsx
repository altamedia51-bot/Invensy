...
export const Layout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-slate-900 overflow-hidden font-sans text-slate-800 dark:text-slate-200 transition-colors">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col bg-slate-50 dark:bg-slate-950 w-full min-w-0 transition-colors">
        <div className="md:hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 h-16 flex items-center px-4 shrink-0 transition-colors">
